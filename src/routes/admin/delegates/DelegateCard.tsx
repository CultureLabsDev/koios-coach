...
export default ({ my_user, client }: Props) => {
  ...
  return (
    ...
    >
      <a href={`/admin/delegates/${client.uid}`}>
        <div class="card-body card-hover-text-white">
          <div class="flex justify-between tooltip" data-tip={client.name.length > 17 ? name : null}>
